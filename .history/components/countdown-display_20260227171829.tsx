      ...
      <div className=" rounded-3xl shadow-2xl p-8 md:p-12">
        <div className="flex items-center justify-center gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm md:text-base font-bold tracking-widest bg-gradient-to-r from-[#1F2A23] to-white bg-clip-text text-transparent">HOURS</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm md:text-base font-bold tracking-widest bg-gradient-to-r from-[#1F2A23] to-white bg-clip-text text-transparent">MINUTES</p>
          </div>
          ...
          {/* Seconds Box */}
            ...
            <p className="text-sm md:text-base font-bold tracking-widest bg-gradient-to-r from-[#1F2A23] to-white bg-clip-text text-transparent">SECONDS</p>
          </div>
        </div>
      </div>
