      ...
      <div className=" rounded-3xl shadow-2xl p-8 md:p-12">
        <div className="flex items-center justify-center gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="bg-[#0A6522] rounded-2xl px-8 md:px-12 py-6 md:py-8 shadow-lg">
          ...
          {/* Seconds Box */}
            ...
            <p className="text-sm md:text-base font-bold text-[#0A6522] tracking-widest">SECONDS</p>
          </div>
        </div>
      </div>
